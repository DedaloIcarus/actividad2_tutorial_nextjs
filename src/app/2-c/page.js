        ...
        <div className="text-center p-10">
            ...
            <div className="text-start">
                <p>
                    ...
                    <br/>
                    <br/>
                    A su vez, Next.js permite trabajar tanto con CSS tradicional como CSSin-JS que incorpora soluciones
                    como styled-components para escribir
                    CSS dentro de los archivos JavaScript.
                    <br/>
                    <br/>
                    Si bien es cierto que Next.js no usa HTML de manera directa, sí permite
                    trabajar con una estructura similar a HTML a través de JSX para escribir
                    elementos HTML dentro de funciones de JavaScript, pero con una
                    sintaxis especial que es procesada por React para generar el DOM.
                    <br/>
                    <br/>
                    ...
                    formato JSON al interactuar con APIs o cuando se realizan consultas
                    en el lado del servidor (SSR) o en rutas de API.
                </p>
            </div>
        </div>
    );
