    ...
    <div className="text-center p-10">
      ...
      <div className="text-start">
        <p>
          ...
          <br />
          <span className="underline">npm</span> es el gestor de paquetes
          predeterminado que se utiliza para instalar dependencias y paquetes en
          proyectos de Node.js.
          <br />
          <span className="underline">Yarn</span> es otro gestor de paquetes
          similar a npm, pero algunas personas prefieren usarlo por su velocidad
          y características adicionales.
          <br />
          <br />
          <span className="font-bold underline">Un editor de código</span> como
          puede ser Visual Studio Code, Sublime Text, Atom y un largo etcétera
          para poder escribir y editar el código.
        </p>
      </div>
    </div>
  );
