    ...
    return (
        <div className="text-center p-10">
            ...
            <div className="text-start">
                <p>
                    Este tutorial proporciona una introducción detallada al uso del framework
                    Next.js.
                    <br/>
                    El tutorial, sirve como una guía para la instalación y configuración de un
                    proyecto Next.js, el manejo de rutas, variables de entorno y la estructura de
                    directorios.
                    <br/>
                    ...
                    avanzadas que aporta el framework para la realización de la aplicación.
                </p>
            </div>
        </div>
    );
