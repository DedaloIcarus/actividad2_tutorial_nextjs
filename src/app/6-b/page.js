        ...
        <div className="text-center p-10">
            ...
            <div className="text-start">
                <p>
                    ...
                    y ficheros.
                    <br/>
                    Como ya es sabido, en el directorio app se encuentran las páginas
                    que componen la aplicación, por lo que editando estos archivos
                    realizaremos cambios en las páginas.
                    <br/>
                    También existe la posibilidad de personalizar la configuración del
                    framework modificando el fichero de configuración (next.config.js).
                    Si lo que se busca es colocar y/o editar componentes, se deberá
                    modificar el directorio components.
                    <br/>
