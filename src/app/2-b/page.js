  ...
  return (
    <div className="text-center p-10">
      ...
      <div className="text-start">
        <p>
          Next.js es un framework extremadamente versátil que se puede utilizar
          en una variedad de aplicaciones y casos de uso como pueden ser sitios
          web estáticos (blog, porfolios…), aplicaciones web dinámicas
          ...
          aplicaciones con autenticación y gestión de sesión, y un largo
          etcétera.
        </p>
      </div>
    </div>
