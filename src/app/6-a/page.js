        ...
        <div className="text-center p-10">
            ...
            <div className="text-start">
                <p>
                    ...
                    <br/>
                    <br/>
                    Next.js también gestiona tanto los ficheros estáticos (en el directorio
                    public) como los componentes y módulos JavaScript (directorios
                    components y lib respectivamente).
                    <br/>
                    <br/>
                    Se pueden crear y organizar componentes de interfaz (como
                    encabezados y pies de página) A través del layout
                </p>
            </div>
        </div>
    );
